...
if [ ! -f Gemfile ]; then
  ...
  echo ""
  echo "docker run -p 4000:4000 -v \$(pwd):/site thr3d33/jekyll-serve"
  echo ""
  echo "NOTE: To create a new site, you can use the sister image thr3d33/jekyll like:"
  echo ""
  echo "docker run -v \$(pwd):/site thr3d33/jekyll new ."
  exit 1
fi
